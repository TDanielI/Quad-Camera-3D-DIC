function [A1, A2] = get_rectification_transforms(t, R)
%%%
% Input
...
% Output
% - A1 : Affine matrix transforming frame 1 to rectified frame
% - A2 : Affine matrix transforming frame 2 to rectified frame
%%%
